...
const ProductAndCategories = ({ products, Categories, mainColor, logo }) => {
    const [cat, setcat] = useState("all")
    const filteredProducts = cat === 'all'
        ? products.result.filter(e => e.show)
        : products.result.filter(e => e.show).filter(product => product.type === cat);
    return (
        <div>
            {Categories.length > 0 && (
                    ...
                    <div className="container mx-auto px-4 md:px-8">
                        ...
                        <div className="text-center mb-10">
                            ...
                            <div
                                ...
                                className="w-16 h-1 mx-auto rounded-full"></div>
                        </div>
